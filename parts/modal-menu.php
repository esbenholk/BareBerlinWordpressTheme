		...
		<div class="menu-wrapper section-inner">
			...
			<div class="menu-top">
				...
				<div class="menu-modal-toggles header-toggles">
					...
					<a href="#" class="toggle nav-toggle nav-untoggle closing-tag" data-toggle-target=".menu-modal" data-toggle-screen-lock="true" data-toggle-body-class="showing-menu-modal" aria-pressed="false" data-set-focus="#site-header .nav-toggle" role="button"> 
